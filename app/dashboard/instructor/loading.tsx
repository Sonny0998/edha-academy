      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="h-16 bg-card border-b border-border px-6 flex items-center gap-4">
          ...
          <div className="ml-auto flex gap-2">
            <div className="h-8 w-28 bg-bg2 rounded-xl" />
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <div className="bg-card border border-border rounded-2xl overflow-hidden">
            <div className="p-4 border-b border-border flex justify-between items-center">
              <div className="h-5 w-32 bg-bg2 rounded" />
              <div className="h-8 w-24 bg-bg2 rounded-xl" />
            </div>
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex items-center gap-4 p-4 border-b border-border last:border-0">
                <div className="h-14 w-20 bg-bg2 rounded-xl shrink-0" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-bg2 rounded w-2/3" />
                  <div className="h-3 bg-bg2 rounded w-1/3" />
                </div>
                <div className="h-6 w-20 bg-bg2 rounded-full" />
              </div>
            ))}
          </div>
        </div>
